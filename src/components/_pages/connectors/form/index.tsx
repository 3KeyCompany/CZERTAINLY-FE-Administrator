                                    ...
                                    render={({ field: { onChange, value, ...field }, fieldState }) => (
                                        <>
                                            <input
                                                ...
                                                className={cn(
                                                    'py-2.5 sm:py-3 px-4 block w-full border-outline rounded-lg text-sm focus:border-brand focus:ring-brand disabled:opacity-50 disabled:pointer-events-none bg-surface-raised text-content-subtle placeholder-content-subtle/50',
                                                    {
